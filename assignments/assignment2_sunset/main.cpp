...
int main() {
	...
	std::string vertexShaderSource = sf::loadShaderSourceFromFile("assets/vertexShader.vert");
	std::string fragmentShaderSource = sf::loadShaderSourceFromFile("assets/fragmentShader.frag");
